...
class Symbol(object):
    """Emoji symbol class"""
    def __init__(self, e):
        """Constructor of the Symbol. Do not call it manually. Use `Symbol.load()` insted
        ...
        self._id = e['id']
        self._text_fallback = e.get('text_fallback', "")
        self._text_repr = e.get('text_repr', "")
    ...
    str = property(lambda self: self._unicode)
